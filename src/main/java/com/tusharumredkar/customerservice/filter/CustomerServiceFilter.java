package com.tusharumredkar.customerservice.filter;
...
@Component
public class CustomerServiceFilter extends OncePerRequestFilter {

	private final static Logger log = LoggerFactory.getLogger(CustomerServiceFilter.class);
